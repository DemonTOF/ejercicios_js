...
function canBuyProduct() {
    // Tu código aquí...
    const costoProducto = 1500
    const descuento = 25
    const miPlata = 1150
    let pagoFinal = costoProducto*(1 - descuento/100)  // Se calcula el % que queda por pagar, que es del 75%
    console.log(pagoFinal <= 1150)
}
...
function checkDogIdIsString() {
    // Tu código aquí...
    // typeof(string)==="string" para confirmar que ´dogId´ es string y typeof(string) retorna string
    let string = `dogId`
    console.log(typeof(string)==="string",typeof(string))  
...
function logVersion() {
    // Tu código aquí...
    let version = 2024
    console.log('La versión de JavaScript es ' + version)  // Se usa el + para concatenación
}
